...
const stripePromise = loadStripe(
  "pk_test_51RAjmMJAN6Ff3CYXzjjpi9us8IxPkpXV6EfzDPJr2s8G0MD5OfqmYzmYNEmfTpWeulNrgSax1cJFwz9egJ9zSRwo00rlcsJ7ik"
);
...
const OrderSummary = () => {
  ...
  return (
    <motion.div
      className="space-y-4 rounded-lg border border-gray-700 p-4 shadow-lg sm:p-6 bg-black/90 text-white"
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-medium  underline hover:text-gray-700 "
          >
            Continue Shopping
            <MoveRight size={16} />
          </Link>
