...
const GiftCouponCard = () => {
  ...
  return (
    <motion.div
      className="space-y-4 rounded-lg border border-gray-700 p-4 shadow-lg sm:p- bg-black/90"
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            p-2.5 text-sm text-gray-200 placeholder-gray-400 focus:border-emerald-500 
        ...
        <div className="mt-4">
          ...
          <motion.button
            ...
            px-5 py-2.5 text-sm font-medium text-white hover:bg-red-700 focus:outline-none
             focus:ring-4 focus:ring-red-300 cursor-pointer"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
